...
router.get('/sliders/create', uploadPath.sliderUpload.array('images', 10), slidersController.sliders_create);
router.post('/sliders/create', uploadPath.sliderUpload.array('images', 10), slidersController.sliders_store);
